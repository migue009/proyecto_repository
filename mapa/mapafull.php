...
<body>
    ...
    <form method="post" action="mapafull.php">
        <input type="image" name="image" src="<?php echo $urlImage; ?>" border="1" id="mapImage">
    </form>

    <p>
        <b>Coordenadas en píxeles:</b> <?php echo  $_POST['image_x'] . " , " . $_POST['image_y']; ?>
        <br>
        <b>Coordenadas en el mapa:</b> <?php echo $map_pt[0] . " , " . $map_pt[1]; ?>
    </p>
    ...
    <script>
        ...
        // Cuando el usuario haga clic en el "x", cerrar el modal

            ...
            <div class="row mt-4">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="usu_genero" id="usu_genero" class="form-select">
                        <option value="M" <?php echo $usu['sex_id'] == 1 ? 'selected' : ''; ?>>Masculino</option>
                        <option value="F" <?php echo $usu['sex_id'] == 2 ? 'selected' : ''; ?>>Femenino</option>
                    </select>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="usu_rol" id="usu_rol" class="form-select">
                        <option value="admin" <?php echo $usu['rol_id'] == 1 ? 'selected' : ''; ?>>Administrador</option>
                        <option value="user" <?php echo $usu['rol_id'] == 2 ? 'selected' : ''; ?>>Usuario</option>
                    </select>
                </div>
            </div>
